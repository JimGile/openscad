...
module box_piece(piece_num, thickness, edge_notch_list, boxLetters, slop = 0.05, rounding_radius = 1) {
    ...
    //Translations List
    t = [
        [-slop,         side_len-thickness+slop,    -slop], //Top
        [thickness+slop,-slop,                      -slop], //Left
        [-slop,         -slop,                      -slop], //Bot
        [side_len+slop, -slop,                      -slop]  //Right
    ];
    //Rotations List
    r = [
        [0,0,0],    //Top
    ...
    difference() {
        ...
        translate([side_len/2, side_len/2, thickness/2])
        roundedBox(size=[side_len, side_len, thickness],radius=rounding_radius);
        //Remove edge notches
        for (e=[0:NUM_EDGES-1]) {
            translate(t[e])
            rotate(r[e])
...
//        translate(t[3])
//        rotate(r[3])
//        #notched_edge(3, thickness, edge_notch_list[3], slop);
        //Remove Letter
