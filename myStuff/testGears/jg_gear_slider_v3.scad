...
//jg_gear_2slider_assembly(length, mm_per_tooth, thickness, rounding_radius, gear_num_teeth, gear_hole);
//jg_gear_2slider_assembly();

//JG Gear and 2 Sliders Assembly Module
module jg_gear_2slider_assembly(
    length = 100,
    mm_per_tooth = 5,
    thickness= 3,
    rounding_radius = 1,
...
module jg_slider(
    ...
    //Triangle
    translate([0, rack_height, thickness*2])
        rotate([180,0,0])
