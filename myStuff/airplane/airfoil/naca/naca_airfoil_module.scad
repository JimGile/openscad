...
lgth=c*3/4;
//step=c*t/2.5; //c/lgth; for c=15 -> 2.5, for c=30 -> 3.5, l=26.25 -> 3.5, 13.125 -> 2.5
//step=c*.05*(c+8)/c;
//step = 45/lgth; //for c=30
//step = 15/lgth; //for c=15
//step=t*lgth/2;
//step=(t*lgth/2)*2/3;
//step=t*lgth/(t*c/2);
step=(t*lgth/2)*2/(t*c/2);

//c=30, l=22.50, step=1.7 or 1.6875 step ratio is 1.5
//c=15, l=11.25, step=1.2 or 1.125

//30,22.50,2.250,3.0
//15,11.25,1.125,1.5, 9 cyl
...
//    for (x =[1:num:lgth]) {
//        echo(x*num);
//        echo(top_chord_line_list[x*5/num]*c/2);
//        translate([x*5/num, top_chord_line_list[x*5/num]*c/2, 0]) 
//        #circle((top_chord_line_list[x*5/num]*c/2)*2/3);
//    }
//}
